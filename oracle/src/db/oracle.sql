...
grant resource, connect to vector;
...
alter table "VECTOR"."DOCS" add constraint "DOCS_PK" primary key ( "ID" );
alter table "VECTOR"."DOCS_CHUNCK" add constraint "DOCS_CHUNCK_PK" primary key ( "ID" );
alter table "VECTOR"."DOCS_CHUNCK" add constraint "DOCS_FK" foreign key ( "DOC_ID" ) references "DOCS" ( "ID" ) on delete cascade;
